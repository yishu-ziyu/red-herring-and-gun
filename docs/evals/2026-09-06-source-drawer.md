...
- 行为测试：`mvp/src/goldenPath/goldenPath.test.tsx` Issue #65 段，15 项均为真实 focus / keydown / click（`cd mvp && npx vitest run src/goldenPath/goldenPath.test.tsx`：**39 通过**）
