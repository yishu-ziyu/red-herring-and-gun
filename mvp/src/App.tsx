        ...
        finalReport={{
          ...
          evidencePursuit: {
            hops: [
              {
                hop: 1,
                atom: "Transformers 随数据与算力扩展良好",
                goal: "找原始发布",
                query: "Transformers scaling laws original paper",
                resultKind: "primary",
              ...
              {
                hop: 2,
                atom: "注意力机制对序列长度是二次复杂度",
                goal: "按原句核验",
                query: "self-attention quadratic complexity sequence length",
                resultKind: "primary",
                resultKindLabel: "原始来源",
                missingAfter: [],
                action: "continue",
              ...
              {
                hop: 3,
                atom: "因此它导致所有长文本任务都会失败",
                goal: "找反证或辟谣",
                query: "transformer long context failure 辟谣",
                resultKind: "unrelated",
                resultKindLabel: "未对上题",
              ...
              },
              {
                ...
                atom: "因此它导致所有长文本任务都会失败",
                goal: "核对当事方",
                query: "transformer long sequence tasks fail 作者 官方",
                resultKind: "repost",
              ...
              },
              {
                ...
                atom: "因此它导致所有长文本任务都会失败",
                goal: "换一个解释框架",
                query: "linear attention long context 替代解释 原始数据",
                resultKind: "empty",
