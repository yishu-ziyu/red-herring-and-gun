/**
 * Memory candidate types — server copy of src/lib/agentRuntime/memoryCandidateTypes.ts
 * Kept in sync so Express can serve /api/agent/memory-candidates without importing client src.
 */
