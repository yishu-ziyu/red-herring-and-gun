 ...
 *
 * `npm run eval:gate` 的考题集。每道算分题必须标 expectsEnterCheck 或 expectsEarlyStop。
 * 退役题见 retiredFromExam，不进总分。
 */
...
/** 退役：原句没有可核对对象，无法给出唯一标准答案，不进总分。 */
export const retiredFromExam: Array<{ id: string; claim: string; reason: string }> = [
  {
    id: "TINY-005",
    claim: "群里那张P图配的侮辱性文字说的是真的",
    reason: "没有具体图片、没有具体文字，无法给出唯一标准答案。",
  },
  {
    id: "TINY-006",
    claim: "短视频里说的某某婚内出轨是真的",
    reason: "占位「某某」，没有可核对对象。",
  },
];
