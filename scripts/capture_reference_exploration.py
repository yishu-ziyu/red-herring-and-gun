...
def run():
    ...
    try:
        with sync_playwright() as p:
            ...
            browser.close()
            print("\n[SUCCESS] All screenshots captured successfully in docs/design/reference-pack/screenshots/")
    finally:
        try:
